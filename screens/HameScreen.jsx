...
const searchFilterCat = (text) => {
  ...
  return (
    ...
    <View style={{ width: '98%'}}>
      <Image style={{width:55,height:55,borderRadius:55/2 ,alignSelf: 'flex-end', marginBottom:10, marginTop:10}} source={require('../assets/dawini6.png')}/>
    </View>
    ...
    <View style={styles.wrapperHeadProducts}>
      ...
      {filterDataCat.length === 0 ?
          <View style={{width: '100%', marginTop: '15%'}}  >
            <Text style={{fontSize: 35, color: 'grey', alignSelf: 'center'}}>Pas des catégories!</Text>
          </View>
        :
         <>
